...
filename = 'C:\Users\berezinm\Documents\InterCorrelation\InterCorrelation\TSNE_heart 868 FDR 0.05 FC 2.xlsx';
...
Y = tsne(data, 'NumDimensions', 2, 'Perplexity', 40, 'LearnRate', 200, 'NumPCAComponents', 100);
...
function txt = myupdatefcn(~, event_obj, geneNames, Y)
    ...
    txt = {['X: ', num2str(pos(1))], ['Y: ', num2str(pos(2))], ['Gene: ', geneName]};
end
